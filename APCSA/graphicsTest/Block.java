...
public class Block extends Model{
    ...
    public Block(Point3D corner){
        ...
        Tri t4 = new Tri(p2, p4, p6);
        Tri t5 = new Tri(p1, p4, p7);
        Tri t6 = new Tri(p1, p3, p7);
        Tri t7 = new Tri(p2, p6, p5);
        Tri t8 = new Tri(p6, p8, p5);
        Tri t9 = new Tri(p4, p6, p8);
        Tri t10 = new Tri(p4, p7, p8);
        Tri t11 = new Tri(p3, p5, p8);
        Tri t12 = new Tri(p3, p7, p8);
